###########################################################################
## Makefile generated for component 'v2_q_Control_PI'. 
## 
## Makefile     : v2_q_Control_PI.mk
## Generated on : Sat Sep 12 12:45:21 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/v2_q_Control_PI.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/v2_q_Control_PI.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/include -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/v2_q_Control_PI_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32 -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/variants/esp32 -I$(ARDUINO_ESP32_ROOT)/tools/esptool_py -I$(ARDUINO_ESP32_ROOT)/tools/mkspiffs -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(MATLAB_ROOT)/toolbox/target/shared/freertos/include -I$(START_DIR)/include
...
DEFINES_STANDARD = -DMODEL=v2_q_Control_PI -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


v2_q_Control_PI.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/v2_q_Control_PI.c
	$(CC) $(CFLAGS) -o "$@" "$<"


v2_q_Control_PI_data.o : $(START_DIR)/v2_q_Control_PI_ert_rtw/v2_q_Control_PI_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
